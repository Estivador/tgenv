...
tgenv install 0.23.14 || error_and_proceed "Install failed"
tgenv use 0.23.14 || error_and_proceed "Use failed"
check_version 0.23.14 || error_and_proceed "Version check failed"
